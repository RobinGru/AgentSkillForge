---
name: vue-refactor-assistant
description: Use when refactoring large Vue 3 Composition API or Nuxt .vue components step by step without changing existing behavior.
---
